...
You can use the following template as a starting point. [link:https://github.com/devcntr-app/antora-extensions-registry/blob/main/templates/antora-registry.md[Download Template]]

...
You can use the following template as a starting point. [link:https://github.com/asciidoc-supplemental/antora-extensions-registry/blob/main/templates/antora-registry.md[Download Template]]
